...
public:
	...
	struct key_compare_s
	{
		...
		{	
			...
			return (CBTreeMap::comp (rKey0, rKey1, sCompareSelect) < 0);
		}
	};
	...
	struct value_compare_s
	{
		...
		{	
			...
			return (CBTreeMap::comp (rVal0.first, rVal1.first, sCompareSelect) < 0);
		}
	};
	...
	CBTreeMap_t &			operator=				(CBTreeMap_t &rBT);
