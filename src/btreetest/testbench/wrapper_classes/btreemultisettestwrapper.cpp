...
CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::CBTreeMultiSetTestWrapper (const uint32_t nNodeSize, const uint32_t nPageSize)
	:	CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_ref_container> (nNodeSize, nPageSize)
{
	this->m_nNumContainers = CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::m_nNumContainersMS;
...
template<class _t_data, class _t_value, class _t_ref_container>
CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::CBTreeMultiSetTestWrapper (const CBTreeMultiSetTestWrapper &rContainer)
...
template<class _t_data, class _t_value, class _t_ref_container>
CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::~CBTreeMultiSetTestWrapper ()
{
}

template<class _t_data, class _t_value, class _t_ref_container>
template<class _t_iterator>
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::insert (_t_iterator sIterFirst, _t_iterator sIterLast)
{
	uint32_t		i = 0;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::insert<_t_iterator>: ERROR: Unexpected number of test containers!");
...
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::insert (_t_dummy_iterator &rIterDummy, _t_iterator sIterFirst, _t_iterator sIterLast)
{
	rIterDummy;
...
template<class _t_data, class _t_value, class _t_ref_container>
typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::iterator CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::insert (const typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::value_type &rData)
{
...
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::insert_self_reference (_t_iterator sIterFirst, _t_iterator sIterLast, _t_test_iterator &rIterTest)
{
	uint32_t			i = 0;
...
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::test_all_containers_insert (_t_ext_container *pExtContainer, _t_ext_iterator &rExtPos, _t_ref_iterator &rIterBegin, _t_ref_iterator &rIterFirst, _t_ref_iterator &rIterLast) const
{
...
template<class _t_data, class _t_value, class _t_ref_container>
typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::key_compare CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::key_comp () const
{
	key_compare		sRetval;
...
template<class _t_data, class _t_value, class _t_ref_container>
typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::value_compare CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::value_comp () const
{
...
template<class _t_data, class _t_value, class _t_ref_container>
bool CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::run_key_compare (const typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::key_type &rKey0, const typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::key_type &rKey1) const
{
	...
	for (i = 0; i < this->get_num_containers (); i++)
	{
		...
		{
			::std::cerr << "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::run_key_compare: ERROR: comparison result mismatch!" << ::std::endl;
...
template<class _t_data, class _t_value, class _t_ref_container>
bool CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::run_value_compare (const typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::value_type &rVal0, const typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::value_type &rVal1) const
{
	...
	for (i = 0; i < this->get_num_containers (); i++)
	{
		...
		if (bRefValue != bTestValue)
		{
			::std::cerr << "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::run_value_compare: ERROR: comparison result mismatch!" << ::std::endl;
...
template<class _t_data, class _t_value, class _t_ref_container>
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers (const uint32_t nNodeSize, const uint32_t nPageSize)
{
	...
	m_pContainerRAM6565_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM6555_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM5555_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM5554_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM5454_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM5444_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM4444_n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, &sCacheDescPageSize, nNodeSize, this->m_pReference);
	m_pContainerRAM6565_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM6555_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5555_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5554_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5454_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5444_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM4444_2n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, &sCacheDescPageSize, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM6565_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM6555_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5555_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5554_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5454_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5444_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM4444_4n = new CBTreeTestMultiSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerFile6565min = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesMin6565, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerFile6555min = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesMin6555, &sCacheDescPageSize, nNodeSize * 8, this->m_pReference);
	m_pContainerFile5555min = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesMin5555, &sCacheDescMin, nNodeSize * 7, this->m_pReference);
	m_pContainerFile5554min = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesMin5554, &sCacheDescNearestBigger, nNodeSize * 6, this->m_pReference);
	m_pContainerFile5454min = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesMin5454, &sCacheDescLarge, nNodeSize * 5, this->m_pReference);

	m_pContainerFile6565default = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesDefault6565, &sCacheDescNearestBigger, nNodeSize * 3, this->m_pReference);
	m_pContainerFile6555default = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault6555, &sCacheDescNearestBigger, nNodeSize * 2, this->m_pReference);
	m_pContainerFile5555default = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault5555, &sCacheDescLarge, nNodeSize, this->m_pReference);
	m_pContainerFile5554default = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesDefault5554, &sCacheDescPageSize, nNodeSize * 8, this->m_pReference);
	m_pContainerFile5454default = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesDefault5454, &sCacheDescMin, nNodeSize * 7, this->m_pReference);

	m_pContainerFile6565large = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesLarge6565, &sCacheDescPageSize, nNodeSize * 5, this->m_pReference);
	m_pContainerFile6555large = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesLarge6555, &sCacheDescPageSize, nNodeSize * 4, this->m_pReference);
	m_pContainerFile5555large = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault5555, &sCacheDescMin, nNodeSize * 3, this->m_pReference);
	m_pContainerFile5554large = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesDefault5554, &sCacheDescNearestBigger, nNodeSize * 2, this->m_pReference);
	m_pContainerFile5454large = new CBTreeTestMultiSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesDefault5454, &sCacheDescLarge, nNodeSize, this->m_pReference);

	BTREE_ASSERT (NULL != m_pContainerRAM6565_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6565_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6555_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6555_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5555_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5555_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5554_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5554_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5454_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5454_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5444_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5444_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM4444_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM4444_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6565_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6565_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6555_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6555_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5555_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5555_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5554_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5554_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5454_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5454_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5444_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5444_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM4444_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM4444_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6565_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6565_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6555_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6555_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5555_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5555_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5554_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5554_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5454_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5454_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5444_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5444_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM4444_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM4444_4n)");
	BTREE_ASSERT (NULL != m_pContainerFile6565min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6565min)");
	BTREE_ASSERT (NULL != m_pContainerFile6555min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6555min)");
	BTREE_ASSERT (NULL != m_pContainerFile5555min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5555min)");
	BTREE_ASSERT (NULL != m_pContainerFile5554min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5554min)");
	BTREE_ASSERT (NULL != m_pContainerFile5454min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5454min)");

	BTREE_ASSERT (NULL != m_pContainerFile6565default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6565default)");
	BTREE_ASSERT (NULL != m_pContainerFile6555default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6555default)");
	BTREE_ASSERT (NULL != m_pContainerFile5555default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5555default)");
	BTREE_ASSERT (NULL != m_pContainerFile5554default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5554default)");
	BTREE_ASSERT (NULL != m_pContainerFile5454default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5454default)");

	BTREE_ASSERT (NULL != m_pContainerFile6565large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6565large)");
	BTREE_ASSERT (NULL != m_pContainerFile6555large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6555large)");
	BTREE_ASSERT (NULL != m_pContainerFile5555large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5555large)");
	BTREE_ASSERT (NULL != m_pContainerFile5554large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5554large)");
	BTREE_ASSERT (NULL != m_pContainerFile5454large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5454large)");
}

template<class _t_data, class _t_value, class _t_ref_container>
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_ref_container> &rWrapper)
{
	uint32_t	i = 0;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper &): ERROR: Unexpected number of test containers instantiated!");

	i = 0;

	BTREE_ASSERT (NULL != m_pContainerRAM6565_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6565_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6555_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6555_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5555_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5555_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5554_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5554_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5454_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5454_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5444_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5444_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM4444_n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM4444_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6565_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6565_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6555_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6555_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5555_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5555_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5554_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5554_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5454_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5454_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5444_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5444_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM4444_2n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM4444_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6565_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6565_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6555_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM6555_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5555_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5555_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5554_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5554_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5454_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5454_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5444_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM5444_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM4444_4n, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerRAM4444_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6565min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6565min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6555min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6555min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5555min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5555min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5554min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5554min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5454min, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5454min)"); i++;

	BTREE_ASSERT (NULL != m_pContainerFile6565default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6565default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6555default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6555default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5555default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5555default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5554default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5554default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5454default, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5454default)"); i++;

	BTREE_ASSERT (NULL != m_pContainerFile6565large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6565large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6555large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile6555large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5555large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5555large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5554large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5554large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5454large, "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers: ERROR: insufficient memory! (m_pContainerFile5454large)"); i++;

	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper &): ERROR: Unexpected number of test containers checked to be instantiated successfully!");
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper &): ERROR: Unexpected number of test containers after setting reference container!");
}

template<class _t_data, class _t_value, class _t_ref_container>
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::transfer_containers ()
{
	uint32_t		i = 0;
...
void CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::test_one_container_insert	(_t_ext_container *pExtOriginal, _t_ext_container *pExtReference, _t_ext_sizetype nPos, typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::size_test_type nFirst, typename CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::size_test_type nLast, _t_ext_iterator &rExtIter, _t_iterator &rIter, _t_source_container *pSrc) const
{
	...
	{
		::std::cerr << "CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::test_one_container_insert: ERROR: size mismatch!" << ::std::endl << ::std::flush;
...
template<class _t_data, class _t_value, class _t_ref_container>
const uint32_t CBTreeMultiSetTestWrapper<_t_data, _t_value, _t_ref_container>::m_nNumContainersMS = 36;
