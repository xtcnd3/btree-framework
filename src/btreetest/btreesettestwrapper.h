...
class CBTreeSetTestWrapper	:	public CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_ref_container>
{
public:

	typedef CBTreeSetTestWrapper<_t_data, _t_value, _t_ref_container>		CBTreeSetTestWrapper_t;
	...
	typedef struct value_compare_s<value_type>					value_compare;
							...
							CBTreeSetTestWrapper<_t_data, _t_value, _t_ref_container>
